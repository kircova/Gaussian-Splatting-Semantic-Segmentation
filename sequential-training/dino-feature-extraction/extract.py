...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="dino-feature-extraction/ckpts/dino_vitbase8_pretrain.pth")
    ...
    parser.add_argument("--dir_dst", type=str, default="dino-feature-extraction/data")
